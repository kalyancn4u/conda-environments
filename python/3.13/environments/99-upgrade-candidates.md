...
## 4. Remove — not needed on Python 3.13 🗑️

Installing these on 3.13 is at best redundant and at worst **actively breaks imports**.
...
| **pip `ipython==8.12.3`** | Pinned to the last 3.8-compatible line for no reason on 3.13. | Let conda-forge resolve IPython. |
