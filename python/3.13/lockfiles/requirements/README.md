...
<sub>📍 [conda-environments](../../../../README.md) › [Python 3.13](../../README.md) › [lockfiles](../README.md) › **requirements**</sub>
...
> ⚠️ **These `.txt` files target Python 3.13 + linux** (the CD deploy target). A uv
...
> ```bash
> uv pip compile 04-web.in -o 04-web-win.txt --python-version 3.13 --python-platform windows
> # …or a single cross-platform file:
> uv pip compile 04-web.in -o 04-web.txt     --python-version 3.13 --universal
> ```
...
uv pip compile 04-web.in -o 04-web.txt --python-version 3.13 --python-platform linux
```
